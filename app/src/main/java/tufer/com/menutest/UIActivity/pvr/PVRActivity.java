...
public class PVRActivity extends MstarBaseActivity {
    ...
    private LayoutParams lp4LoopAB;
    ...
    private void findView() {
        ...
        lp4LoopAB = new LayoutParams(0, dip2px(5));
    ...
    private void settingUSB() {
        ...
        usbSelecter.setUSBListener(new USBDiskSelecter.usbListener() {
    ...
    /**
     * @param diskPath like /mnt/usb/sda1
     */
