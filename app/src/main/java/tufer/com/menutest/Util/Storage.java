...
public class Storage {
    ...
    public StorageInfor getInternalStorage() {
        ...
        try {
            ...
            mFreeStorage = (long) mDataFileStats.getAvailableBlocks()
    ...
    public StorageInfor getDiskStorage() {
        ...
        try {
            mTotalStorage = (long) mSDCardFileStats.getBlockCount()
                    * mSDCardFileStats.getBlockSize();
            mFreeStorage = (long) mSDCardFileStats.getAvailableBlocks()
                    * mSDCardFileStats.getBlockSize();
